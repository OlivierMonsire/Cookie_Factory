...
if(isset($_GET['add_to_cart'])){
    $numb = $_GET['add_to_cart'];
    $name = $catalog[$numb]['name'];
    echo $name;
        ...
        <div class="container-fluid">
            ...
            <div> <?php
                if (isset($_SESSION['login_name'])){
                    echo "Tu es génial, $_SESSION[login_name]";
                } else {
                    echo "Bonjour, n'oublies pas de te connecter si tu veux
                    profiter de ces délicieux cookies!";
                }
                ?>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <?php
                        if (isset($_SESSION['login_name'])){?>
                            <a href="/login.php?action=logout" class="btn btn-danger navbar-btn">
